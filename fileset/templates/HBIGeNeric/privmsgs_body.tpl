  ...
  <tr> 
	<td valign="top" align="center" width="100%" class="MainMenuRow"> 
	  <table height="40" cellspacing="2" cellpadding="2" border="0">
		<tr valign="middle"> 
		  <td>{INBOX_IMG}</td>
		  <td><span class="MainMenuLink">{INBOX} &nbsp;</span></td>
		  <td>{SENTBOX_IMG}</td>
		  <td><span class="MainMenuLink">{SENTBOX} &nbsp;</span></td>
		  <td>{OUTBOX_IMG}</td>
		  <td><span class="MainMenuLink">{OUTBOX} &nbsp;</span></td>
		  <td>{SAVEBOX_IMG}</td>
		  <td><span class="MainMenuLink">{SAVEBOX} &nbsp;</span></td>
		</tr>
	  </table>
	</td>
	<td align="right"> 
...
<table width="100%" border="0">
  <tr> 
	<td align="right" valign="top" class="MainMenuRow">{JUMPBOX}</td>
  </tr>
</table>
