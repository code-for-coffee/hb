...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center" class="BoardColumn">
	<tr>
		<td align="left" class="nav"><a href="{U_INDEX}" class="BoardColumnLink">{L_INDEX}</a></td>
	</tr>
</table>
...
<table width="100%" cellspacing="2" border="0" align="center">
	<tr>
		<td align="right" valign="middle" nowrap="nowrap" class="BoardColumn"><span class="gensmall">{S_TIMEZONE}</span><br /><br />{JUMPBOX}</td> 
	</tr>
</table>
