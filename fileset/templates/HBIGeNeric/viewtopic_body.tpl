<table width="100%" cellpadding="3" cellspacing="0" border="0">
  <tr>
    <td width="80%" align="left" class="BoardColumn"><a class="MainMenuLink" href="{U_VIEW_FORUM}">{FORUM_NAME}</a>: <a class="MainMenuLink" href="{U_VIEW_TOPIC}">{TOPIC_TITLE}</a><br />
...
<table width="100%" cellpadding="3" cellspacing="1" border="0">
  <tr>
    ...
    <td width=20% rowspan=3 class='BoardRowHeading' valign="top"><span class="AuthorLink"><a class="AuthorLink" href="{postrow.HB_PROFILE}" alt="View {postrow.HB_POSTER_NAME}'s Profile">{postrow.POSTER_NAME}</a></span><br>
...
<td width=80% class='BoardRowHeading'><a name="{postrow.U_POST_ID}"></a>
...
<span class="SignatureText">{postrow.SIGNATURE}</span><br><br></td>
</tr>
<tr><td class="BoardRowBody" align="right">
    ...
    <a href="{U_POST_REPLY_TOPIC}"><img src="templates/HBIGeNeric/images/replysmall.gif" border="0"></a></td>
</tr>
</td>
</tr></table>
<!-- END postrow -->                                                                                    
