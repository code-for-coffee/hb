...
<table class="BoardRowBody" width="100%" cellspacing="1" cellpadding="4" border="0">
	<tr> 
		<th class="BoardRowHeading" colspan="7" height="25"><b>{L_GROUP_INFORMATION}</b></th>
	</tr>
	<tr> 
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="BoardRowBody">
	<tr> 
	  <th class="BoardRowHeading" height="25"><b>{L_PM}</b></th>
	  <th class="BoardRowHeading"><b>{L_USERNAME}</b></th>
	  <th class="BoardRowHeading"><b>{L_POSTS}</b></th>
	  <th class="BoardRowHeading"><b>{L_FROM}</b></th>
	  <th class="BoardRowHeading"><b>{L_EMAIL}</b></th>
	  <th class="BoardRowHeading"><b>{L_WEBSITE}</b></th>
	  <th class="BoardRowHeading"><b>{L_SELECT}</b></th>
	</tr>
	<tr> 
	  <td class="BoardRowHeading" colspan="8" height="28"><span class="cattitle"><b>{L_GROUP_MODERATOR}</b></span></td>
	</tr>
	<tr> 
	  <td class="BoardRowBody" align="center"> {MOD_PM_IMG} </td>
	  <td class="BoardRowBody" align="center"><span class="gen"><a href="{U_MOD_VIEWPROFILE}" class="gen">{MOD_USERNAME}</a></span></td>
	  <td class="BoardRowBody" align="center" valign="middle"><span class="gen">{MOD_POSTS}</span></td>
	  <td class="BoardRowBody" align="center" valign="middle"><span class="gen">{MOD_FROM}</span></td>
	  <td class="BoardRowBody" align="center" valign="middle"><span class="gen">{MOD_EMAIL_IMG}</span></td>
	  <td class="BoardRowBody" align="center">{MOD_WWW_IMG}</td>
	  <td class="BoardRowBody" align="center"> &nbsp; </td>
	</tr>
	<tr> 
	  <td class="BoardRowHeading" colspan="8" height="28"><b>{L_GROUP_MEMBERS}</b></td>
	</tr>
	<!-- BEGIN member_row -->
	<tr> 
	...
	<tr> 
	  <td class="BoardRowBody" colspan="7" align="center"><span class="gen">{L_NO_MEMBERS}</span></td>
	</tr>
	<!-- END switch_no_members -->

	<!-- BEGIN switch_hidden_group -->
	<tr> 
	  <td class="BoardRowBody" colspan="7" align="center"><span class="gen">{L_HIDDEN_MEMBERS}</span></td>
	</tr>
...
<table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
	<tr>
		...
		<!-- BEGIN switch_mod_option -->
		<span class="BoardRowBodyLink"><input type="text"  class="post" name="username" maxlength="50" size="20" /> <input type="submit" name="add" value="{L_ADD_MEMBER}" class="mainoption" /> <input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></span><br /><br />
		<!-- END switch_mod_option -->
		<span class="nav">{PAGE_NUMBER}</span></td>
		<td align="right" valign="top" class="BoardRowBody"><span class="BoardRowBodyLink">{S_TIMEZONE}</span><br /><span class="nav">{PAGINATION}</span></td>
	</tr>
</table>
