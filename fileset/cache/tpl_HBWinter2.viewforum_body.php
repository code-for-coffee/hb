...
// eXtreme Styles mod cache. Generated on Sat, 19 Feb 2005 23:52:09 -0800 (time=1108885929)
...
<tr>
  ...
  <td class="BoardRowHeading"><span style='font-size: 6pt;'><?php echo isset($topicrow_item['LAST_POST_TIME']) ? $topicrow_item['LAST_POST_TIME'] : ''; ?> <?php echo isset($topicrow_item['LAST_POST_AUTHOR']) ? $topicrow_item['LAST_POST_AUTHOR'] : ''; ?><?php echo isset($topicrow_item['LAST_POST_IMG']) ? $topicrow_item['LAST_POST_IMG'] : ''; ?></a></td>
