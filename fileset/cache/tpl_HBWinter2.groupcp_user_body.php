...
// eXtreme Styles mod cache. Generated on Sun, 20 Feb 2005 16:39:15 -0800 (time=1108946355)
...
?>
  <tr> 
	<td><span class="BoardRowBodyLink"><?php echo isset($this->vars['L_YOU_BELONG_GROUPS']) ? $this->vars['L_YOU_BELONG_GROUPS'] : $this->lang('L_YOU_BELONG_GROUPS'); ?></span></td>
	<td align="right"> 
...
?>
  <tr> 
	<td class="BoardRowBody"><span class="BoardRowBodyLink"><?php echo isset($this->vars['L_PENDING_GROUPS']) ? $this->vars['L_PENDING_GROUPS'] : $this->lang('L_PENDING_GROUPS'); ?></span></td>
...
?>
  <tr> 
	<th colspan="2" align="center" class="BoardRowHeading" height="25"><?php echo isset($this->vars['L_JOIN_A_GROUP']) ? $this->vars['L_JOIN_A_GROUP'] : $this->lang('L_JOIN_A_GROUP'); ?></th>
  </tr>
  <tr> 
	<td class="BoardRowBody"><span class="gen"><?php echo isset($this->vars['L_SELECT_A_GROUP']) ? $this->vars['L_SELECT_A_GROUP'] : $this->lang('L_SELECT_A_GROUP'); ?></span></td>
	<td class="BoardRowBody" align="right"> 
	  <table width="90%" cellspacing="0" cellpadding="0" border="0">
		<tr><form method="get" action="<?php echo isset($this->vars['S_USERGROUP_ACTION']) ? $this->vars['S_USERGROUP_ACTION'] : $this->lang('S_USERGROUP_ACTION'); ?>">
