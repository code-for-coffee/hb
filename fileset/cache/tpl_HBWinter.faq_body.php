...
// eXtreme Styles mod cache. Generated on Thu, 10 Feb 2005 12:52:41 -0800 (time=1108068761)

?><table width="100%" cellspacing="2" cellpadding="2" border="0" align="center" class="BoardColumn"><tr><td>

<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center" class="BoardColumn">
	<tr>
		<td align="left" class="nav"><a href="<?php echo isset($this->vars['U_INDEX']) ? $this->vars['U_INDEX'] : $this->lang('U_INDEX'); ?>" class="BoardColumnLink"><?php echo isset($this->vars['L_INDEX']) ? $this->vars['L_INDEX'] : $this->lang('L_INDEX'); ?></a></td>
	</tr>
</table>

<table class="BoardRowHeading" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
	<tr>
...
?>
<table class="BoardRowBody" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
	<tr> 
...
<table width="100%" cellspacing="2" border="0" align="center">
	<tr>
		<td align="right" valign="middle" nowrap="nowrap" class="BoardColumn"><span class="gensmall"><?php echo isset($this->vars['S_TIMEZONE']) ? $this->vars['S_TIMEZONE'] : $this->lang('S_TIMEZONE'); ?></span><br /><br /><?php echo isset($this->vars['JUMPBOX']) ? $this->vars['JUMPBOX'] : $this->lang('JUMPBOX'); ?></td> 
	</tr>
</table>
