...
// eXtreme Styles mod cache. Generated on Sat, 22 Jan 2005 07:35:04 +0000 (time=1106379304)
...
<table class="BoardRowBody" width="100%" cellspacing="1" cellpadding="4" border="0">
	<tr> 
		<th class="BoardRowHeading" colspan="7" height="25"><b><?php echo isset($this->vars['L_GROUP_INFORMATION']) ? $this->vars['L_GROUP_INFORMATION'] : $this->lang('L_GROUP_INFORMATION'); ?></b></th>
	</tr>
	<tr> 
		...
		<td class="row2"><span class="gen"><b><?php echo isset($this->vars['GROUP_NAME']) ? $this->vars['GROUP_NAME'] : $this->lang('GROUP_NAME'); ?></b></span></td>
	</tr>
	<tr> 
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="BoardRowBody">
	<tr> 
	  <th class="BoardRowHeading" height="25"><b><?php echo isset($this->vars['L_PM']) ? $this->vars['L_PM'] : $this->lang('L_PM'); ?></b></th>
	  <th class="BoardRowHeading"><b><?php echo isset($this->vars['L_USERNAME']) ? $this->vars['L_USERNAME'] : $this->lang('L_USERNAME'); ?></b></th>
	  <th class="BoardRowHeading"><b><?php echo isset($this->vars['L_POSTS']) ? $this->vars['L_POSTS'] : $this->lang('L_POSTS'); ?></b></th>
	  <th class="BoardRowHeading"><b><?php echo isset($this->vars['L_FROM']) ? $this->vars['L_FROM'] : $this->lang('L_FROM'); ?></b></th>
	  <th class="BoardRowHeading"><b><?php echo isset($this->vars['L_EMAIL']) ? $this->vars['L_EMAIL'] : $this->lang('L_EMAIL'); ?></b></th>
	  <th class="BoardRowHeading"><b><?php echo isset($this->vars['L_WEBSITE']) ? $this->vars['L_WEBSITE'] : $this->lang('L_WEBSITE'); ?></b></th>
	  <th class="BoardRowHeading"><b><?php echo isset($this->vars['L_SELECT']) ? $this->vars['L_SELECT'] : $this->lang('L_SELECT'); ?></b></th>
	</tr>
	<tr> 
	  <td class="BoardRowHeading" colspan="8" height="28"><span class="cattitle"><b><?php echo isset($this->vars['L_GROUP_MODERATOR']) ? $this->vars['L_GROUP_MODERATOR'] : $this->lang('L_GROUP_MODERATOR'); ?></b></span></td>
	</tr>
	<tr> 
	  <td class="BoardRowBody" align="center"> <?php echo isset($this->vars['MOD_PM_IMG']) ? $this->vars['MOD_PM_IMG'] : $this->lang('MOD_PM_IMG'); ?> </td>
	  <td class="BoardRowBody" align="center"><span class="gen"><a href="<?php echo isset($this->vars['U_MOD_VIEWPROFILE']) ? $this->vars['U_MOD_VIEWPROFILE'] : $this->lang('U_MOD_VIEWPROFILE'); ?>" class="gen"><?php echo isset($this->vars['MOD_USERNAME']) ? $this->vars['MOD_USERNAME'] : $this->lang('MOD_USERNAME'); ?></a></span></td>
	  <td class="BoardRowBody" align="center" valign="middle"><span class="gen"><?php echo isset($this->vars['MOD_POSTS']) ? $this->vars['MOD_POSTS'] : $this->lang('MOD_POSTS'); ?></span></td>
	  <td class="BoardRowBody" align="center" valign="middle"><span class="gen"><?php echo isset($this->vars['MOD_FROM']) ? $this->vars['MOD_FROM'] : $this->lang('MOD_FROM'); ?></span></td>
	  <td class="BoardRowBody" align="center" valign="middle"><span class="gen"><?php echo isset($this->vars['MOD_EMAIL_IMG']) ? $this->vars['MOD_EMAIL_IMG'] : $this->lang('MOD_EMAIL_IMG'); ?></span></td>
	  <td class="BoardRowBody" align="center"><?php echo isset($this->vars['MOD_WWW_IMG']) ? $this->vars['MOD_WWW_IMG'] : $this->lang('MOD_WWW_IMG'); ?></td>
	  <td class="BoardRowBody" align="center"> &nbsp; </td>
	</tr>
	<tr> 
	  <td class="BoardRowHeading" colspan="8" height="28"><b><?php echo isset($this->vars['L_GROUP_MEMBERS']) ? $this->vars['L_GROUP_MEMBERS'] : $this->lang('L_GROUP_MEMBERS'); ?></b></td>
	</tr>
	<?php
...
?>
	<tr> 
	  <td class="BoardRowBody" colspan="7" align="center"><span class="gen"><?php echo isset($this->vars['L_NO_MEMBERS']) ? $this->vars['L_NO_MEMBERS'] : $this->lang('L_NO_MEMBERS'); ?></span></td>
	</tr>
	<?php
...
?>
	<tr> 
	  <td class="BoardRowBody" colspan="7" align="center"><span class="gen"><?php echo isset($this->vars['L_HIDDEN_MEMBERS']) ? $this->vars['L_HIDDEN_MEMBERS'] : $this->lang('L_HIDDEN_MEMBERS'); ?></span></td>
	</tr>
	<?php
...
?>
	<tr>
		<td class="BoardRowBody" colspan="8" align="right"><span class="cattitle">
			<input type="submit" name="remove" value="<?php echo isset($this->vars['L_REMOVE_SELECTED']) ? $this->vars['L_REMOVE_SELECTED'] : $this->lang('L_REMOVE_SELECTED'); ?>" class="mainoption" />
		</td>
	</tr>
	<?php
...
<table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
	<tr>
		<td align="left" valign="top" class="BoardRowBody">
		<?php
...
?>
		<span class="BoardRowBodyLink"><input type="text"  class="post" name="username" maxlength="50" size="20" /> <input type="submit" name="add" value="<?php echo isset($this->vars['L_ADD_MEMBER']) ? $this->vars['L_ADD_MEMBER'] : $this->lang('L_ADD_MEMBER'); ?>" class="mainoption" /> <input type="submit" name="usersubmit" value="<?php echo isset($this->vars['L_FIND_USERNAME']) ? $this->vars['L_FIND_USERNAME'] : $this->lang('L_FIND_USERNAME'); ?>" class="liteoption" onClick="window.open('<?php echo isset($this->vars['U_SEARCH_USER']) ? $this->vars['U_SEARCH_USER'] : $this->lang('U_SEARCH_USER'); ?>', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></span><br /><br />
		<?php
...
?>
		...
		<td align="right" valign="top" class="BoardRowBody"><span class="BoardRowBodyLink"><?php echo isset($this->vars['S_TIMEZONE']) ? $this->vars['S_TIMEZONE'] : $this->lang('S_TIMEZONE'); ?></span><br /><span class="nav"><?php echo isset($this->vars['PAGINATION']) ? $this->vars['PAGINATION'] : $this->lang('PAGINATION'); ?></span></td>
	</tr>
</table>
